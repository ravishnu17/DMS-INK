      ...
      <div>
        <div className="d-flex justify-content-between align-items-center p-2 bg-white">
          <div class="d-flex align-items-center gap-2">
            <i className="fa-solid fa-circle-left fs-5" style={{ margin: "10px" }} onClick={() => navigate('/nonfinancial/department')}></i>
            <h6 className="fw-bold mb-0">Department 1 - {location.state?.name}</h6>
          </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="mb-3">
                ...
                <p className="ms-2 fw-bold">Department 1</p>
              </div>
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="modal-body">
                <div className="mb-3">
                  <label className="form-label">Department Name</label>
                  <input type="text" className="form-control" {...register("departmentName")} placeholder='Enter Department Name' />
