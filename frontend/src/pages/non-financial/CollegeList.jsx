      ...
      <div className='p-2 bg-white'>
        <div className="d-flex justify-content-between align-items-center m-2">
          <div className="d-flex align-items-center gap-2">
            <i className="fa-solid fa-circle-left fs-5" style={{ margin: "10px" }} onClick={() => navigate('/nonfinancial/college')}></i>
            <h6 className="fw-bold mb-0">College 1 - {location.state?.name}</h6>
          </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="mb-3">
                ...
                <p className="ms-2 fw-bold">College 1</p>
              </div>
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="modal-body">
                <div className="mb-3">
                  <label className="form-label">College Name</label>
                  <input type="text" className="form-control" {...register("collegeName")} placeholder='Enter College Name' />
                  <p className="text-danger">{errors.collegeName?.message}</p>
                </div>
