  ...
  return (
    <div className="card p-4 pt-2 shadow">
      <div className='d-flex align-items-center justify-content-between mb-3 border-bottom'>
        ...
        <h6 className="fw-bold text-dark mb-0">Parish 1 - {location.state.name}</h6>
        <div />
      </div>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="row">
          <div className="col-md-5 mb-3">
            <label className="form-label">Parish No</label>
            <input {...register("societyNo")} className={`form-control ${errors.societyNo ? "is-invalid" : ""}`} placeholder="Enter Parish No" />
