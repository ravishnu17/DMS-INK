...
function SocialSectorList() {
  const navigate = useNavigate();
  const location = useLocation();
  const data = [
    {
      id: 1,
      name: "Social Sector 1",
  ...
  const schema = yup.object().shape({
    socialSectorName: yup.string().required("Social Sector Name is required"),
      ...
      <div>
        <div className="d-flex justify-content-between align-items-center p-2 bg-white">
          <div class="d-flex align-items-center gap-2">
            <i className="fa-solid fa-circle-left fs-5" style={{ margin: "10px" }} onClick={() => navigate('/nonfinancial/socialSector')}></i>
            <h6 className="fw-bold mb-0">Social Sector 1 - {location.state?.name}</h6>
          </div>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="mb-3">
                <label className="form-label">Social Sector Name</label>
                <p className="ms-2 fw-bold">Social Sector 1</p>
              </div>
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="modal-body">
                <div className="mb-3">
                  <label className="form-label">Social Sector Name</label>
                  <input type="text" className="form-control" {...register("socialSectorName")} placeholder='Enter Social Sector Name' />
                  <p className="text-danger">{errors.socialSectorName?.message}</p>
                </div>
...
export default SocialSectorList