...
const schema = yup.object().shape({
  companyNo: yup.string().required("Company No is required"),
  ...
  return (
      <div className="card p-4 pt-2 shadow m-2">
        <div className='d-flex align-items-center justify-content-between mb-3 border-bottom'>
          ...
          <h6 className="fw-bold text-dark mb-0">Company 1 - {location.state?.name}</h6>
          <div />
        </div>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="row">
            <div className="col-md-4 mb-3">
              ...
              <input {...register("companyNo")} className={`form-control ${errors.companyNo ? "is-invalid" : ""}`} placeholder="Enter Company No" />
              <div className="invalid-feedback">{errors.companyNo?.message}</div>
            </div>
            <div className="col-md-4 mb-3">
