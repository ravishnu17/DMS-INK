  ...
  return (
    <div className="card p-4 pt-2 shadow">
      <div className="d-flex align-items-center justify-content-between mb-3 border-bottom">
        ...
        <h6 className="fw-bold text-dark mb-0">College 1 - {location.state?.name}</h6>
        <div />
      </div>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="row">
          <div className="col-md-4 mb-3">
            <label className="form-label">College No</label>
            <input
              {...register("collegeNo")}
              className={`form-control ${errors.collegeNo ? "is-invalid" : ""}`}
              placeholder="Enter College No"
            />
            <div className="invalid-feedback">{errors.collegeNo?.message}</div>
          </div>
          <div className="col-md-4 mb-3">
