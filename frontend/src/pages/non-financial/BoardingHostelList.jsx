...
function BoardingHostelList() {
  const navigate = useNavigate();
  const location = useLocation();
  const data = [
    {
      id: 1,
      name: "Boarding & Hostel 1",
  ...
  const schema = yup.object().shape({
    boardingHostelName: yup.string().required("Boarding & Hostel Name is required"),
        ...
        <div className='p-2 bg-white'>
          <div className="d-flex justify-content-between align-items-center m-2">
            <div class="d-flex align-items-center gap-2">
              <i className="fa-solid fa-circle-left fs-5" style={{ margin: "10px" }} onClick={() => navigate('/nonfinancial/boardingHostel')}></i>
              <h6 className="fw-bold mb-0">Boarding & Hostel 1 - {location.state?.name}</h6>
            </div>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="mb-3">
                <label className="form-label">Boarding & Hostel Name</label>
                <p className="ms-2 fw-bold">Boarding & Hostel 1</p>
              </div>
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="modal-body">
                <div className="mb-3">
                  <label className="form-label">Boarding & Hostel Name</label>
                  <input type="text" className="form-control" {...register("boardingHostelName")} placeholder='Enter Boarding & Hostel Name' />
                  <p className="text-danger">{errors.boardingHostelName?.message}</p>
                </div>
...
export default BoardingHostelList