...
function ParishList() {
  ...
  const schema = yup.object().shape({
    parishName: yup.string().required("Parish Name is required"),
      ...
      <div >
        ...
        <div className="d-flex justify-content-between align-items-center m-2">
          <div class="d-flex align-items-center gap-2">
            <i className="fa-solid fa-circle-left fs-5" style={{ margin: "10px" }} onClick={() => navigate('/nonfinancial/parish')}></i>
            <h6 className="fw-bold mb-0">Parish 1 - {location.state?.name}</h6>
          </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="mb-3">
                ...
                <p className="ms-2 fw-bold">Parish 1</p>
              </div>
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="modal-body">
                <div className="mb-3">
                  <label className="form-label">Parish Name</label>
                  <input type="text" className="form-control" {...register("parishName")} placeholder='Enter Parish Name' />
                  <p className="text-danger">{errors.parishName?.message}</p>
                </div>
