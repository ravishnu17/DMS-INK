...
function BoardingHostel() {
  ...
  const [boardingHostelList, setBoardingHostelList] = useState([]);
  ...
  // const modulepermission = permissions?.role_permissions?.[`boarding and hostel`];
  ...
  useEffect(() => {
    ...
    if (contextProp?.permissions) {
      setmodulepermission(
        contextProp?.permissions?.role_permissions?.[`boarding and hostel`] ||
          {}
      );
    }
  }, [contextProp]);
  ...
  // const initial = { code: "", name: "", address: "", place: "", socity_id: null, community_id: null, country_id: null, state_id: null, region_id: null, district_id: null, incharge_user_id: null, viewr_user_id: null }
  const initial = {
    id: "",
    code: "",
    name: "",
  ...
  const getPortfolio = () => {
    setLoading(true);
    getAPI(
      "/config/portfolio?skip=0&limit=25&type=Non%20Financial&search=Boarding"
    )
      .then((res) => {
        if (res?.data?.status) {
  ...
  const columns = [
    {
      name: "#",
      selector: (row, index) => pagination.skip + index + 1, // Assigns auto-incrementing serial numbers
      width: "50px",
    },
...

    {
                  ...
                  {/* <div className="form_col ml-1">
                      <span className="custum-group-table" >
                        <button type="button" className="btn  btn-sm text-info" title='Manage files'
                          //  onClick={() => { contextProp.setNavState({ ...row, module: 'Boarding Hostel' }); navigate('/nonfinancial/boardingHostel') }}  
                          onClick={() => mainManageFiles(row, navigate, portfolioIds, 'boardingHostel')}
                        >
      ...
      allowoverflow: true,
      // maxwidth: "600px",
      maxWidth: "200px", // Ensure the column doesn't expand too much
      fixed: "right",
    },
  ];
  ...
  const onSubmit1 = (data) => {
    ...
    const mapping = "POST";
    addUpdateAPI(mapping, "config/boarding-hostel/import", formData).then(
      (res) => {
        if (res?.data?.status) {
          setSearch("");
          getPortfolios();
  ...
  const downloadExcel = () => {
    fetch(API_BASE_URL + "config/entities/sample-export?portfolio_id=7", {
      method: "GET",
      headers: {
        "Content-Type":
          "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      ...
      .then((blob) => {
        ...
        a.href = url;
        a.download = "Boarding_Hostel_Form.xlsx"; // Change the file name if needed
  ...
  const downloadCommunityExcel = () => {
    fetch(API_BASE_URL + "config/entity-portfolio/export?portfolio_id=7", {
      method: "GET",
      headers: {
        "Content-Type":
          "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      ...
      .then((response) => {
        response.blob().then((blob) => {
          ...
          const a = document.createElement("a");
          a.href = url;
          a.download = "Boarding_Hostel_List.xlsx"; // Change the file name if needed
          document.body.appendChild(a);
          a.click();
          a.remove();
        });
    ...
    <>
      <div>
        <div className="d-flex justify-content-between p-2 flex-wrap bg-white">
          <div className="p-2 col-lg-6 col-12">
            {/* <h6 className="fw-bold mb-0">Boarding & Hostel</h6>
             */}
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button
                  ...
                  type="button"
                  role="tab"
                  onClick={() => navigate("/boardingHostel")}
                >
                  Boarding & Hostel
                </button>
              </li>
          ...
          <div className="d-flex justify-content-end col-lg-6 col-12 p-2 flex-wrap gap-2 align-items-end">
            ...
            currentUser?.role?.name === "Super Admin" ? (
              <>
                <button
                  ...
                  data-bs-target="#addModel"
                  onClick={() => {
                    setIsEdit(false), setSelectedData(null), reset(initial);
                  }}
                >
                  Add{" "}
                </button>
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">
                {isEdit ? "Edit Boarding Hostel" : "Add Boarding Hostel"}{" "}
              </h5>
              <button
                type="button"
              ...
              <div className="modal-body">
                <div className="row ms-1">
                  ...
                  {isEdit && (
                    <div className="mb-1 col-md-3">
                      ...
                      <input
                        ...
                        placeholder="Enter Boarding Hostel Code"
                        {...register("code")}
                      />
                  ...
                  <div className="col-md-3 mb-1">
                    ...
                    />
                    <p className="text-danger">
                      {errors.viewer_admin_user_id?.message}
                    </p>
                  </div>
                </div>
      ...
      >
        <div className="modal-dialog modal-xl">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="row ms-1 border-bottom border-secondary mb-5">
                <div className="col-md-3 mb-1">
                ...
                <div className="col-md-3 mb-1">
                  ...
                  <p className="ms-2 fw-bold"> {watch("type") || "N/A"}</p>
                </div>
                <div className="mb-1 col-md-3">
      ...
      >
        <div className="modal-dialog modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Import Borading Hostel</h5>
              <button
                type="button"
                className="btn-sm btn-close"
                data-bs-dismiss="modal"
