...
function TechnicalInstitute() {
  ...
  // const modulepermission = permissions?.role_permissions?.[`technical institutions`];
  ...
  //     financialAssistant: yup.string().required("Financial Assistant is required"),
  ...
  const buildValidationSchema = (modules) => {
    ...
    return yup.object().shape({
      ...
      state_id: yup.object().required("State is required"),
      district_id: yup.object().required("District is required"),
      financialAssistant: yup
        .string()
        .trim()
        .required("Financial Assistant is required"),
      community_id: yup.object().required("Community is required"),
      socity_id: yup.object().required("Society is required"),
      type: yup.string().trim().required("Type is required"),
      board: yup.string().trim().required("Board is required"),
  ...
  const [tableLoading, setTableLoading] = useState(true); // For main table
  ...
  const getPortfolio = () => {
    setLoading(true);
    getAPI(
      "/config/portfolio?skip=0&limit=25&type=Non%20Financial&search=Technical Institutions"
    )
      .then((res) => {
        if (res?.data?.status) {
      ...
      .then((res) => {
        if (res?.data?.status) {
          if (type === "expanded") {
            ...
            setValue("board", res?.data?.data?.board);
                  ...
                  {/* <div className="form_col ml-1">
                      <span className="custum-group-table" >
                        <button type="button" className="btn  btn-sm text-info" title='Manage files'
                          // onClick={() => { contextProp.setNavState({ ...row, module: 'Technical Institute' }); navigate('/nonfinancial/technicalInstitute') }} 
                          onClick={() => mainManageFiles(row, navigate, portfolioIds, 'technicalInstitute')}
                        >
  ...
  const onSubmit = (data) => {
    ...
    const submitdata = {
      ...
      name: data.name || null,
      type: data?.type || null,
      financial_assistance: data.financialAssistant || null,
    ...
    addUpdateAPI(mapping, url, submitdata).then((res) => {
      if (res?.data?.status) {
        ...
        Swal.fire({
          ...
          title: res?.data?.details || "Success",
          showConfirmButton: false,
          timer: 3000,
          timerProgressBar: true,
          background: " #28a745",
  ...
  const onSubmit1 = (data) => {
    ...
    const mapping = "POST";
    addUpdateAPI(mapping, "config/technical-institute/import", formData).then(
      (res) => {
        if (res?.data?.status) {
          getPortFolioList();
          getUserOptions();
  ...
  const downloadExcel = () => {
    fetch(API_BASE_URL + "config/entities/sample-export?portfolio_id=" + String(techPortfolioId), {
      ...
      .then((blob) => {
        ...
        a.href = url;
        a.download = "TechnicalInstitute_Form.xlsx"; // Change the file name if needed
    ...
    fetch(API_BASE_URL + "config/entity-portfolio/export?portfolio_id=" + String(techPortfolioId), {
      ...
      .then((response) => {
        response.blob().then((blob) => {
          ...
          const a = document.createElement("a");
          a.href = url;
          a.download = "TechnicalInstitute_List.xlsx"; // Change the file name if needed
          document.body.appendChild(a);
          a.click();
          a.remove();
        });
    ...
    <>
      <div>
        <div className="d-flex justify-content-between p-2 flex-wrap bg-white">
          <div className="p-2 col-lg-6 col-12">
            {/* <h6 className="fw-bold mb-0">Technical Institution</h6>
             */}
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button
                  ...
                  data-bs-target="#home"
                  type="button"
                  onClick={() => navigate("/technicalInstitute")}
                  role="tab"
                >
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">
                {isEdit
                  ? "Edit Technical Institution"
                  : "Add Technical Institution"}
              </h5>
              <button
                type="button"
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="modal-body">
                <div className="row ms-1">
                  ...
                  <div className="col-md-3 mb-1">
                    <label className="form-label">
                      Financial Assistant <span className="text-danger">*</span>
                    </label>
                    ...
                    <p className="text-danger">
                      {errors.financialAssistant?.message}
                    </p>
                  </div>
                  <div className="col-md-3 mb-1">
                    <label className="form-label">
                    ...
                    >
                      ...
                      <option value="SCVT/NCVT">SCVT/NCVT</option>
                    </select>
      ...
      >
        <div className="modal-dialog modal-xl">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">View Technical Institute</h5>
              <button
                type="button"
                className="btn-sm btn-close"
                data-bs-dismiss="modal"
            ...
            <div className="modal-body">
              <div className="row ms-1 border-bottom border-secondary mb-5">
                ...
                <div className="col-md-3 mb-1">
                  <label className="form-label">Technical Institute Code</label>
                ...
                <div className="col-md-3 mb-1">
                  ...
                  <p className="ms-2 fw-bold">{watch("board") || "N/A"}</p>
                </div>
                <div className="col-md-3 mb-1">
                ...
                <div className="col-md-3 mb-1">
                  <label className="form-label">Financial Assistant </label>

                  <p className="ms-2 fw-bold">
                    {watch("financialAssistant") || "N/A"}
                  </p>
                </div>
      ...
      >
        <div className="modal-dialog modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Import Technical Institute</h5>
              <button
                type="button"
                className="btn-sm btn-close"
                data-bs-dismiss="modal"
